 ...
 * Converts any accepted raster image to optimized WebP and stores it under
 * /public/uploads with a random name (never user-controlled → no traversal).
 * Response: { ok: true, path: "/uploads/<name>.webp" } | { ok: false, error }
 */
